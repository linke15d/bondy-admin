  ...
  setup() {
    ...
    return () => (
      ...
      >
        ...
        <div class="h-full flex items-center">
          {/*<div class="flex items-center mr-5 relative" v-show={!userStore.$state.isMerchant}>
            <el-icon size="20"><bell /></el-icon>
            <span class="w-2 h-2 bg-[red] rounded-1 absolute top-0 right-0" v-show={props.notifyType}></span>
          </div> */}
          {screenfull.value ? (
